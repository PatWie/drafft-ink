...
use drafftink_widgets::{
    ...
    StrokeWidthButton, TAILWIND_COLORS, ToggleButton, menu_item as widgets_menu_item,
    menu_item_enabled as widgets_menu_item_enabled, menu_separator as widgets_menu_separator,
    panel_frame as widgets_panel_frame, section_label as widgets_section_label,
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.vertical(|ui| {
                        ...
                        ui.horizontal(|ui| {
                            ...
                            let (clicked, rect) =
                                color_swatch_current(ui, ui_state.stroke_color, "Current stroke");
                    ...
                    ui.vertical(|ui| {
                        ...
                        ui.horizontal(|ui| {
                            ...
                            let (clicked, rect) =
                                color_swatch_current(ui, current_fill, "Current fill");
                    ...
                    ui.vertical(|ui| {
                        ...
                        if props.is_text {
                            ...
                            ui.horizontal(|ui| {
                                ...
                                let is_architects =
                                    props.font_family == FontFamily::ArchitectsDaughter;
                                if ToggleButton::new("Architects", is_architects).show(ui)
                                    && !is_architects
                                {
            ...
            Frame::new()
                ...
                .show(ui, |ui| {
                    ...
                    ui.vertical(|ui| {
                        ...
                        let btn = egui::Button::new(
                            egui::RichText::new(button_text).color(Color32::WHITE),
                        )
