...
use drafftink_render::{
    AngleSnapInfo, GridStyle, PngRenderResult, RenderContext, Renderer, TextEditResult,
    TextEditState, TextKey, TextModifiers, VelloRenderer,
};
            ...
            WindowEvent::KeyboardInput { event, .. } => {
                ...
                match event.state {
                    ElementState::Pressed => {
                        state
                            .input
                            .handle_key_event(KeyEvent::Pressed(key_str.to_string()));
                    ...
                    ElementState::Released => {
                        state
                            .input
                            .handle_key_event(KeyEvent::Released(key_str.to_string()));
                    }
                }
            }
